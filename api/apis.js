const weatherAPIKey = 'b161bd751b22182906f6760c412c4511';
const mapboxAPIKey = 'pk.eyJ1IjoibWs4MDYiLCJhIjoiY2txM252am4zMGw4ZTJ2bzB6MXV4cDdneCJ9.vJGQoGUs6p37TYHSEZXWdw';
...
async function fetchWeather(lat, long) {
    let promise = fetch(
        `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${long}&exclude=minutely,hourly,alerts&units=metric&appid=${weatherAPIKey}`
